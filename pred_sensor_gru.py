...
MODEL_PATH = "sensor_gru.pt"
SCALER_PATH = "sensor_gru_scaler.joblib"
...
def predict(data_dir: str | None):
    ...
    x_values = build_input_sequence(sensor_values, last_timestamp, scaler)
...
def predict_future(steps=288):
    ...
    for _ in range(steps):
        ...
        x_values = build_input_sequence(sensor_values, current_time, scaler)
